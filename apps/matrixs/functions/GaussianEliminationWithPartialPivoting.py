...
def eliminacionParcial(A,b):
        html="</br>Gaussian elimination with partial pivoting</br></br>"

        Ab, html = eliminacionGaussianaConPivoteo(A, b, len(A), html)
